...
\urlstyle{same}
\hypersetup{
  pdftitle={Adriel Nathanael Simatupang},
  pdfauthor={18224109 Adriel N S},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{Adriel Nathanael Simatupang}
\usepackage{etoolbox}
\makeatletter
...
{\centering \includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{images/TEST.jpeg}
...
Halo! Saya Adriel Nathanael Simatupang, mahasiswa S1 di Sekolah Teknik
Elektro dan Informatika (STEI) ITB, Program Studi Sistem dan Teknologi
Informasi. Saya lahir di Jakarta, 27 Mei 2006, dan merupakan anak ke-2
dari 3 bersaudara.

\section*{✨ Minat dan Tujuan}\label{minat-dan-tujuan}
\addcontentsline{toc}{section}{✨ Minat dan Tujuan}

\markright{✨ Minat dan Tujuan}

Saya punya ketertarikan besar pada teknologi informasi, terutama yang
bisa memberi dampak sosial nyata. Tujuan saya sederhana, yaitu
menggabungkan logika teknologi dengan nilai kemanusiaan. Saya ingin
membangun sistem yang bukan cuma cerdas tapi juga bermanfaat bagi orang
lain.

\begin{quote}
``Teknologi seharusnya tidak hanya mempermudah hidup manusia, tapi juga
membuatnya lebih bermakna.''
\end{quote}

\section*{🧠 Keahlian}\label{keahlian}
\addcontentsline{toc}{section}{🧠 Keahlian}
...
\tightlist
\item
  💻 \textbf{Pemrograman:} Python, C, Java, C++\\
\item
  ⚙️ \textbf{Tools:} Git, VS Code, Quarto
\end{itemize}

\section*{🎯 Proyek dan Aktivitas}\label{proyek-dan-aktivitas}
\addcontentsline{toc}{section}{🎯 Proyek dan Aktivitas}

\markright{🎯 Proyek dan Aktivitas}

\begin{itemize}
\tightlist
\item
  \textbf{Sistem Manajemen Rumah Sakit} --- aplikasi C dengan konsep
  struktur data.\\
\item
  \textbf{Website Pribadi} --- dibuat dengan Quarto sebagai media
  eksplorasi diri.
\end{itemize}

\section*{📬 Kontak}\label{kontak}
\addcontentsline{toc}{section}{📬 Kontak}

\markright{📬 Kontak}

📧
\href{mailto:adrielnathanaels@gmail.com}{\nolinkurl{adrielnathanaels@gmail.com}}\\
📸 \href{https://instagram.com/adrielnathanael.s}{adrielnathanael.s}

\bookmarksetup{startatroot}

\chapter*{All About Me!}\label{all-about-me}
\addcontentsline{toc}{chapter}{All About Me!}

\markboth{All About Me!}{All About Me!}

\begin{figure}[H]

{\centering \includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{All_About_me/images/TEST.jpeg}
...
\section*{✨ Minat dan Tujuan}\label{minat-dan-tujuan-1}
\addcontentsline{toc}{section}{✨ Minat dan Tujuan}
...
\section*{🧠 Keahlian}\label{keahlian-1}
\addcontentsline{toc}{section}{🧠 Keahlian}
...
\section*{🎯 Proyek dan Aktivitas}\label{proyek-dan-aktivitas-1}
\addcontentsline{toc}{section}{🎯 Proyek dan Aktivitas}
...
\addcontentsline{toc}{section}{\textbf{Kisah yang Membentuk Diri Anda:
Mengenal Kekuatan Identitas Naratif}}

\markright{\textbf{Kisah yang Membentuk Diri Anda: Mengenal Kekuatan
Identitas Naratif}}
...
\addcontentsline{toc}{subsection}{\textbf{1. Tiga Lapisan Diri Anda: Di
Mana Cerita Hidup Anda Berada?}}
...
\addcontentsline{toc}{subsection}{\textbf{2. Pola-Pola Kisah Kehidupan:
Apa yang Membuat Sebuah Cerita Bermanfaat?}}
...
\addcontentsline{toc}{subsubsection}{Penebusan vs.~Kontaminasi: Mengubah
...
\addcontentsline{toc}{subsubsection}{Agensi vs.~Kepasifan: Menjadi
Pahlawan dalam Kisah Anda}
...
\addcontentsline{toc}{subsection}{\textbf{3. Seni Memberi Makna:
Kekuatan Super Anda dalam Bernalar}}
...
\addcontentsline{toc}{subsection}{\textbf{4. Mulai Menulis Ulang Kisah
Anda: Dua Langkah Praktis}}
...
\addcontentsline{toc}{subsubsection}{Langkah 1: Pisahkan Diri Anda dari
Masalah}
...
\addcontentsline{toc}{subsubsection}{Langkah 2: Temukan ``Momen
Berkilau'' Anda}
...
\addcontentsline{toc}{subsection}{\textbf{5. Kesimpulan: Kisah Anda
